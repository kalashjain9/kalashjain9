...
- **Insights360:** Customer Behavior Analysis Model  
  User segmentation, predictive modeling, and personalized marketing insights.
- **CryptEmoji:** Emoji-Based Encryption & Decryption  
  Custom emoji encryption algorithm, secure decryption, user-friendly interface.
- **EcoWatt:** Energy Consumption Analysis & Forecasting  
  Time series analysis, forecasting, and data visualization (1965-2023).
- **OptiPrice:** Advanced Option Pricing Tool  
  Real-time option price calculation, option Greeks, and financial visualization.
- **StockSense:** Stock Prediction Model  
  ML-based stock price forecasting (90% accuracy).
- **FinGPT:** AI-Powered Personal Finance Chatbot  
  Budget planning, expense tracking, financial advice with stock integration.
- **EventEase:** Event Planning System  
  Task tracking, budgeting, guest management, and notifications.
